...
const SavedRecord = ({ record }) => {
  // console.log('SavedRecord.js/Record passed in: ', record)
  ...
  // console.log('SavedRecord.js/ paddedHourString, paddedMinutesString, meridianString:',paddedHourString,' ', paddedMinutesString,' ', meridianString)
